...
Vec2 Force::GenerateGravitationalForce(const Body& bodyA, const Body& bodyB, float G, float minDistance, float maxDistance) {
    ...
    float attractionMagnitude = G * (bodyA.mass * bodyB.mass) / distanceSquared;
